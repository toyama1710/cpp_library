...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/1418.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=1418\"\
    ...
    \ {};\n    template<class InputItr>\n    PersistentSegmentTree(const InputItr\
    \ first, const InputItr last)\n        :n(std::distance(first, last)), root(alloc(0,\
    ...
    \      return fold(l, r, 0, n, root);\n    };\n    const T fold(uint ql, uint\
    \ qr, uint nl, uint nr, const Node *np) const {\n        if (np == nullptr ||\
    \ qr <= nl || nr <= ql) return Monoid::identity();\n        else if (ql <= nl\
